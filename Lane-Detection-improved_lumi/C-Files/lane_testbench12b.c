      ...
      for (x=0;x<x_size;x++)
        {
            ...
            lum_lt = ((lum_lt >>4)& 0b0000111111111111);
            lum_ct = ((lum_ct >>4)& 0b0000111111111111);
            lum_rt = ((lum_rt >>4)& 0b0000111111111111);
            lum_lc = ((lum_lc >>4)& 0b0000111111111111);
            lum_rc = ((lum_rc >>4)& 0b0000111111111111);
            lum_lb = ((lum_lb >>4)& 0b0000111111111111);
            lum_cb = ((lum_cb >>4)& 0b0000111111111111);
            lum_rb = ((lum_rb >>4)& 0b0000111111111111);
            ...
            g_sum_2 = (sum_x_2 + sum_y_2)/4096;


            if (g_sum_2 > 4095)

                g_limit = 0b0000111111111111;
            else
                g_limit = ((g_sum_2)& 0b0000111111111111);
