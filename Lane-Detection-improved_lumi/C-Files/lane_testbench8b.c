      ...
      for (x=0;x<x_size;x++)
        {
            ...
            lum_lt = ((lum_lt >>8)& 0b0000000011111111);
            lum_ct = ((lum_ct >>8)& 0b0000000011111111);
            lum_rt = ((lum_rt >>8)& 0b0000000011111111);
            lum_lc = ((lum_lc >>8)& 0b0000000011111111);
            lum_rc = ((lum_rc >>8)& 0b0000000011111111);
            lum_lb = ((lum_lb >>8)& 0b0000000011111111);
            lum_cb = ((lum_cb >>8)& 0b0000000011111111);
            lum_rb = ((lum_rb >>8)& 0b0000000011111111);
            ...
            if (g_sum_2 > 256)
                ...
                g_limit = 0b0000000011111111;
            else
                g_limit = ((g_sum_2)& 0b0000000011111111);
