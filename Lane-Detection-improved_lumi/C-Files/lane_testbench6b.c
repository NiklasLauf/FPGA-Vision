      ...
      for (x=0;x<x_size;x++)
        {
            ...
            lum_lt = ((lum_lt >>10)& 0b0000000000111111);
            lum_ct = ((lum_ct >>10)& 0b0000000000111111);
            lum_rt = ((lum_rt >>10)& 0b0000000000111111);
            lum_lc = ((lum_lc >>10)& 0b0000000000111111);
            lum_rc = ((lum_rc >>10)& 0b0000000000111111);
            lum_lb = ((lum_lb >>10)& 0b0000000000111111);
            lum_cb = ((lum_cb >>10)& 0b0000000000111111);
            lum_rb = ((lum_rb >>10)& 0b0000000000111111);
            ...
            g_sum_2 = (sum_x_2 + sum_y_2)/16;


            if (g_sum_2 > 64)

                g_limit = 0b0000000000111111;
            else
                g_limit = ((g_sum_2)& 0b0000000000111111);

            g_int    = floor(sqrt(g_limit*512)*2);
